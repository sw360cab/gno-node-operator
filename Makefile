...
KIND_CLUSTER ?= gno-node-health-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name gno-node-health-builder
	$(CONTAINER_TOOL) buildx use gno-node-health-builder
	...
	- $(CONTAINER_TOOL) buildx rm gno-node-health-builder
	rm Dockerfile.cross
